  ...
  <div class="card">
    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        ...
        <input type="text" id="nama_institusi" name="institusi" class="form-control @error('institusi') is-invalid @enderror" readonly required>
        @error('institusi')
        <div class="invalid-feedback">{{$message}}</div>
        @enderror
      </div>
    ...
    <div class="row g-3">
      <div class="col-sm-6">
        ...
        <input type="text" id="nama_project" name="project" class="form-control @error('project') is-invalid @enderror" readonly required>
        @error('project')
        <div class="invalid-feedback">{{$message}}</div>
        @enderror
      </div>
